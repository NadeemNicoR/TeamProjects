...
public class Budget extends AppCompatActivity {
    ...
    EditText editBudget_ID, editAmount_B,editCategory_B, editDate_B;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_B = (Spinner) findViewById(R.id.Time);
        //Buttons
    ...
    public  void Save_B() {
        btnSave_B.setOnClickListener(
            new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    boolean isInserted = myDb_B.insertDataB(editAmount_B.getText().toString(), editCategory_B.getText().toString(), editDate_B.getText().toString(),spinner_B.getSelectedItem().toString());
                    if(isInserted == true)
    ...
    public void Delete_B() {
        btnDelete_B.setOnClickListener(new View.OnClickListener() {
                                           @Override
                                           public void onClick(View v) {
                                               Integer deletedRows = myDb_B.deleteDataB(editBudget_ID.getText().toString());
                                               if(deletedRows > 0)
        ...
        btnView_B.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             while (bdg.moveToNext()) {
                                                 ...
                                                 buffer.append("Threshold :"+ bdg.getString(1)+"\n");
                                                 buffer.append("Category :"+ bdg.getString(2)+"\n");
                                                 buffer.append("Date :"+ bdg.getString(3)+"\n");
                                                 buffer.append("Period :"+ bdg.getString(4)+"\n\n\n");
                                             }
                                             showMessage("Budget Plan",buffer.toString());
                                         }
                                     }
        );
    }
