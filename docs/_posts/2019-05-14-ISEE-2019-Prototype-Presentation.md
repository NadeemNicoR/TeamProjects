![companylogo]({{site.baseurl}}/images/405logo.jpeg)
...
![requirementGanthering]({{site.baseurl}}/images/RequirementGathering.jpg) During the weekly team meetings, every question formulated for a team member was collected, after that we processed them into a meeting agenda, which was a powerful tool that helped as to make the correct questions that later could be clarified by the customer.
...
![UserStoriesManagement1]({{site.baseurl}}/images/UserStoriesManagement1.jpeg)
